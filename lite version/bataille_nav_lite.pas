...
type jeuxtbl=array[1..3,1..3] of char;
...
begin
    repeat
        ...
        while ((entrer1<1)or(entrer1>3)or
                (entrer2<1)or(entrer2>3)or
                (sorti1<1)or(sorti1>3)or
                (sorti2<1)or(sorti2>3)) do
        begin
            gotoxy(2,15);
...
begin
    ...
    begin
        ...
        if((entrer1>1)or(entrer1<3)) then
        begin
            if ((entrer2>1)or(entrer2<3)) then
            begin
                if ((map[entrer2-1,entrer1]='X')or
                    (map[entrer2,entrer1]='X')or//erreur se situe ici pk?
...
BEGIN
    ...
    repeat
        ...
        sous_marin:= 3;}
        mini_croiseur:=2;
        nbr_case_nav:=2; //nbr de case occuper par tout les navir
        nJ1:=1;
        nJ2:=2;
        //initialiser les nom
        nom1:=' ';
       ...
       { map1:=initiation_map(map1,car_vide,n_sous_marin,sous_marin);
        ...
        while ((vict2<>true)and(vict1<>true)) do
        begin
            // tour J1
                affiche(s_map2);
                gotoxy(2,14);
